...
class SpeedEstimator(BaseSolution):
    ...
    def connect_to_db(self):
        ...
        try:
            ...
            connection = mysql.connector.connect(
                ...
                password="VNSG"   # Replace with your MySQL password
            )
    ...
    def estimate_speed(self, im0):
        ...
        for box, track_id, cls in zip(self.boxes, self.track_ids, self.clss):
            ...
            cv2.imshow("Licence",cropped_image) ##################################################################
...
# Open the video file
cap = cv2.VideoCapture('C:/Users/ACER/PycharmProjects/MINI_Project/tc.mp4')
...
speed_obj = SpeedEstimator(
    ...
    model="C:/Users/ACER/PycharmProjects/MINI_Project/best.pt",
    line_width=2
)
